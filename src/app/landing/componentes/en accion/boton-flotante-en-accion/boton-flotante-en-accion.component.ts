...
@Component({
  selector: 'app-boton-flotante-en-accion',
  templateUrl: './boton-flotante-en-accion.component.html',
  styleUrls: ['./boton-flotante-en-accion.component.css']
})
export class BotonFlotanteEnAccionComponent implements OnInit{
