...
@Component({
  selector: 'app-boton-flotante-historia',
  templateUrl: './boton-flotante-historia.component.html',
  styleUrls: ['./boton-flotante-historia.component.css']
})
export class BotonFlotanteHistoriaComponent implements OnInit {
  mostrarBoton = false;
  element: any;
  scroll: any;
